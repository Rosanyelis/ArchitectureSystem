                    ...
                    <div class="row">
                        ...
                        <div class="col-12 mb-3">
                            ...
                            <div class="input-group">
                                ...
                                <input type="number" class="form-control" id="dollar_rate" name="dollar_rate" value="{{ $dollarRate->rate ?? 0 }}" required readonly>
                                <input type="hidden" class="form-control" id="dollar_rate_id" name="dollar_rate_id" value="{{ $dollarRate->id ?? 0 }}">
                            </div>
                        </div>
                        <div class="col-12 mb-3">
