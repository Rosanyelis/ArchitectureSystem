                                ...
                                <div class="col-md-4" >
                                    <div class="form-floating form-floating-outline">
                                        <input
                                            ...
                                            id="razon_social"
                                            name="razon_social"
                                            class="form-control @if($errors->has('razon_social')) is-invalid @endif"
                                ...
                                <div class="col-md-4" >
                                    <div class="form-floating form-floating-outline">
                                        <input
                                            ...
                                            value="{{ old('nombre', $supplier->nombre) }}"
                                        />
                                ...
                                <div class="col-md-4" >
                                    <div class="form-floating form-floating-outline">
                                        <input
                                            ...
                                            value="{{ old('apellido', $supplier->apellido) }}"
                                        />
                                ...
                                <div class="col-md-4" >
                                    <div class="form-floating form-floating-outline">
                                        <input
                                            ...
                                            id="cuit"
                                            name="cuit"
                                            class="form-control @if($errors->has('cuit')) is-invalid @endif"
                                            placeholder="Ingrese cuit"
                                            value="{{ old('cuit', $supplier->cuit) }}"
                                        />
                                        <label for="code">CUIT</label>
                                ...
                                <div class="col-md-4" >
                                    <div class="form-floating form-floating-outline">
                                        <input
                                            ...
                                            value="{{ old('correo', $supplier->correo) }}"
                                        />
                                ...
                                <div class="col-md-4" >
                                    <div class="form-floating form-floating-outline">
                                        <input
                                            ...
                                            value="{{ old('provincia', $supplier->provincia) }}"
                                        />
                                ...
                                <div class="col-md-6">
                                    <div class="form-floating form-floating-outline">
                                        <input
                                            ...
                                            value="{{ old('domicilio', $supplier->domicilio) }}"
                                        />
                                ...
                                <div class="col-md-6">
                                    <div class="form-floating form-floating-outline">
                                        <input
                                            ...
                                            value="{{ old('localidad', $supplier->localidad) }}"
                                        />
